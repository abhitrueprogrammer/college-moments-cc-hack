...
export default function Searchbar() {
    ...
    return (
        <div style={{width: "fit-content"}} className="s-div relative mt-7 ml-35 flex justify-start items-center h-8" >
            

            <input className="searchBar" placeholder='Search for club ...'></input>
            <div className="searchIcon absolute right-3">
            <svg width="20" height="20" viewBox="0 0 27 31" fill="none" xmlns="http://www.w3.org/2000/svg">
